...
function setup() {
  ...
  playerBase = new PlayerBase(500, 550, 180, 150);
  player =  new Player(500, playerBase.body.position.y - 153, 50, 180);
  playerArcher = new PlayerArcher(560,playerBase.body.position.y - 180,120,120);

  computerBase = new ComputerBase(1450,550,180,150);
  computer = new Computer(1450,400,50,180);
  computerArcher = new ComputerArcher(1380,400,120,120);
